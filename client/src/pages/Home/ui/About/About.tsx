    ...
    <div className="About">
      <div className="About__container">
        <h2 className="About__title">
          Heavy machinery and construction equipment from AFG Machinery
        </h2>

        <p className="About__desc">
          AFG Machinery is your number one supplier of new and used heavy
          machinery and construction equipment. We sell high-quality equipment
          for the earthmoving- and demolition- industry from leading brands like
          Caterpillar, Komatsu, Volvo, Hyundai and Liebherr. At our headquarters
